...
static void init_context(context_type* context) {
...
static bool check_packet_count(int8_t counter, context_type* vrt_context) {
...
static void vrt_print_context(context_type* vrt_context) {
...
static bool vrt_process(uint32_t* buffer, uint32_t size, context_type* vrt_context, packet_type* vrt_packet) {
...
static void vrt_init_data_packet(struct vrt_packet* p) {
...
static void vrt_init_context_packet(struct vrt_packet* pc) {
